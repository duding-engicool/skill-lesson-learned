...
description: 面向质量/项目工程师，对经验教训做结构化捕获、分类与检索沉淀，避免经验散失，输出 LL 沉淀模板与知识库索引（纯文字版 .txt + Markdown .md）。
slug: lesson-learned
version: 1.0.0
---
...
> 本技能为**结构化沉淀**工具：Agent 充当知识管理助手，与用户交互完成经验教训（Lesson Learned, LL）的结构化捕获、分类与检索，并产出沉淀模板与知识库索引（纯文字版 .txt + Markdown .md）。所有内容以项目真实记录为准，缺失标注「待企业补充」。
...
6. 调用 `scripts/build_report.py` 产出 `经验教训库.md` 与 `经验教训库.txt`。
